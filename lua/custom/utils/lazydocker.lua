-- ~/.config/nvim/lua/custom/utils/lazydocker.lua
local M = {}

-- Function to open lazydocker in a floating window
M.run_lazydocker = function()
  ...
  -- Run lazydocker in the floating window
