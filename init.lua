...
vim.o.undodir = vim.fn.expand '~/undos/nvimk'
...
require('lazy').setup({
  ...
  'MunifTanjim/nui.nvim', -- Dependency for folke/noice below
  'rcarriga/nvim-notify', -- Dependency for folke/noice below
  -- noice
  {
    'folke/noice.nvim',
    event = 'VeryLazy',
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<localleader>t', builtin.find_files, { desc = '[S]earch [F]iles' })
